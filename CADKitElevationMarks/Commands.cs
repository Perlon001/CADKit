...
namespace CADKitElevationMarks
{
    public class Commands
    {
        ...
        public class KotaJig : DrawJig
        {
            ...
            public KotaJig(ObjectIdCollection _ents, Point3d _basePoint)
            {
                ents = _ents;
            ...
            protected override bool WorldDraw(WorldDraw draw)
            {
                ...
                Matrix3d disp = Matrix3d.Displacement(this.basePoint.GetVectorTo(this.currentPosition));

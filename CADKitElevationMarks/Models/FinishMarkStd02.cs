...
namespace CADKitElevationMarks.Models
{
    public class FinishMarkStd02 : Mark
    {
        ...
        protected override IEnumerable<Entity> GetEntities()
        {
            ...
            att1.ColorIndex = 7;
            att1.Height = 2;
            att1.Position = new Point3d(-2, 4.5, 0);
            att1.Justify = AttachmentPoint.MiddleLeft;
            att1.AlignmentPoint = new Point3d(-2, 4.5, 0);
            att1.Tag = "Value";
            att1.Prompt = "Value";
            ...
            pl1.AddVertexAt(0, new Point2d(2.5, 3), 0, 0, 0);
            pl1.AddVertexAt(0, new Point2d(0, 0), 0, 0, 0);
            pl1.AddVertexAt(0, new Point2d(-2.5, 3), 0, 0, 0);
            pl1.AddVertexAt(0, new Point2d(textArea[1].X - textArea[0].X - 1.5, 3), 0, 0, 0);
            en.Add(pl1);
